...
var middlewareSecret = "c06bc22f-48a0-461a-ace0-8699c84f8a38";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFuZnJveGF3bW1lb3VkYnNxcmNqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODcxNzQ1MTMsImV4cCI6MjEwMjc1MDUxM30.KTtEVJRnFa--mTSn89DNThbXHV7JZ6nZXDp9AFS0gUg",
			"PUBLIC_SUPABASE_URL": "https://anfroxawmmeoudbsqrcj.supabase.co",
			"SITE": void 0,
			"SSR": true
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/admin/assign-user",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/admin\\/assign-user\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/admin/assign-user.ts",
			"pathname": "/api/admin/assign-user",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/admin/companies.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/tickets.ts",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/cliente/dashboard.astro",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/cliente/pendiente",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/cliente\\/pendiente\\/?$",
			"segments": [[{
				"content": "cliente",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/cliente/pendiente.astro",
			"pathname": "/cliente/pendiente",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_B-eekgCR.mjs");
var _page1 = () => import("./chunks/dashboard_CDSa-SwC.mjs");
var _page2 = () => import("./chunks/assign-user_zdnGDUO-.mjs");
var _page3 = () => import("./chunks/companies_rFJO5vUI.mjs");
var _page4 = () => import("./chunks/signout_CCCaO4rO.mjs");
var _page5 = () => import("./chunks/tickets_Cqj3YCte.mjs");
var _page6 = () => import("./chunks/dashboard_bYnf0RQz.mjs");
var _page7 = () => import("./chunks/pendiente_B4x85Zc_.mjs");
var _page8 = () => import("./chunks/login_BbYZKwt5.mjs");
var _page9 = () => import("./chunks/register_CgtdU_Rm.mjs");
var _page10 = () => import("./chunks/index_C8ubGqgd.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/admin/dashboard.astro", _page1],
	["src/pages/api/admin/assign-user.ts", _page2],
	["src/pages/api/admin/companies.ts", _page3],
	["src/pages/api/auth/signout.ts", _page4],
	["src/pages/api/tickets.ts", _page5],
	["src/pages/cliente/dashboard.astro", _page6],
	["src/pages/cliente/pendiente.astro", _page7],
...
var _manifest = deserializeManifest({"rootDir":"file:///D:/TRABAJO/FixByte/","cacheDir":"file:///D:/TRABAJO/FixByte/node_modules/.astro/","outDir":"file:///D:/TRABAJO/FixByte/dist/","srcDir":"file:///D:/TRABAJO/FixByte/src/","publicDir":"file:///D:/TRABAJO/FixByte/public/","buildClientDir":"file:///D:/TRABAJO/FixByte/dist/client/","buildServerDir":"file:///D:/TRABAJO/FixByte/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.H25qYCl_.css"},{"type":"external","src":"_astro/dashboard.C5pBwuHU.css"}],"routeData":{"route":"/admin/dashboard","isIndex":false,"type":"page","pattern":"^\\/admin\\/dashboard\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/dashboard.astro","pathname":"/admin/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/assign-user","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/assign-user\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"assign-user","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/assign-user.ts","pathname":"/api/admin/assign-user","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin/companies","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin\\/companies\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin","dynamic":false,"spread":false}],[{"content":"companies","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin/companies.ts","pathname":"/api/admin/companies","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/auth/signout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/auth\\/signout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"auth","dynamic":false,"spread":false}],[{"content":"signout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/auth/signout.ts","pathname":"/api/auth/signout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/tickets","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/tickets\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"tickets","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/tickets.ts","pathname":"/api/tickets","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.H25qYCl_.css"},{"type":"external","src":"_astro/dashboard.BSQQ58xU.css"}],"routeData":{"route":"/cliente/dashboard","isIndex":false,"type":"page","pattern":"^\\/cliente\\/dashboard\\/?$","segments":[[{"content":"cliente","dynamic":false,"spread":false}],[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cliente/dashboard.astro","pathname":"/cliente/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.H25qYCl_.css"},{"type":"external","src":"_astro/pendiente.DaN80UbG.css"}],"routeData":{"route":"/cliente/pendiente","isIndex":false,"type":"page","pattern":"^\\/cliente\\/pendiente\\/?$","segments":[[{"content":"cliente","dynamic":false,"spread":false}],[{"content":"pendiente","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/cliente/pendiente.astro","pathname":"/cliente/pendiente","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.H25qYCl_.css"},{"type":"external","src":"_astro/login.BGoWvjGr.css"}],"routeData":{"route":"/login","isIndex":false,"type":"page","pattern":"^\\/login\\/?$","segments":[[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/login.astro","pathname":"/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.H25qYCl_.css"},{"type":"external","src":"_astro/register.CCQpRiPk.css"}],"routeData":{"route":"/register","isIndex":false,"type":"page","pattern":"^\\/register\\/?$","segments":[[{"content":"register","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/register.astro","pathname":"/register","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/Layout.H25qYCl_.css"},{"type":"external","src":"_astro/index.Fk6fiORk.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/TRABAJO/FixByte/src/pages/admin/dashboard.astro",{"propagation":"none","containsHead":true}],["D:/TRABAJO/FixByte/src/pages/cliente/dashboard.astro",{"propagation":"none","containsHead":true}],["D:/TRABAJO/FixByte/src/pages/cliente/pendiente.astro",{"propagation":"none","containsHead":true}],["D:/TRABAJO/FixByte/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/TRABAJO/FixByte/src/pages/login.astro",{"propagation":"none","containsHead":true}],["D:/TRABAJO/FixByte/src/pages/register.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.Dxpd0rOq.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/admin/assign-user@_@ts":"chunks/assign-user_zdnGDUO-.mjs","\u0000virtual:astro:page:src/pages/api/admin/companies@_@ts":"chunks/companies_rFJO5vUI.mjs","\u0000virtual:astro:page:src/pages/admin/dashboard@_@astro":"chunks/dashboard_CDSa-SwC.mjs","\u0000virtual:astro:page:src/pages/cliente/dashboard@_@astro":"chunks/dashboard_bYnf0RQz.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_B-eekgCR.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_C8ubGqgd.mjs","\u0000virtual:astro:page:src/pages/login@_@astro":"chunks/login_BbYZKwt5.mjs","\u0000virtual:astro:page:src/pages/cliente/pendiente@_@astro":"chunks/pendiente_B4x85Zc_.mjs","\u0000virtual:astro:page:src/pages/register@_@astro":"chunks/register_CgtdU_Rm.mjs","D:/TRABAJO/FixByte/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_Bzvf02Gb.mjs","\u0000virtual:astro:page:src/pages/api/auth/signout@_@ts":"chunks/signout_CCCaO4rO.mjs","\u0000virtual:astro:page:src/pages/api/tickets@_@ts":"chunks/tickets_Cqj3YCte.mjs","D:/TRABAJO/FixByte/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts":"_astro/Layout.astro_astro_type_script_index_0_lang.fR2G1qXN.js","D:/TRABAJO/FixByte/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.D7FV4qqw.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/TRABAJO/FixByte/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.querySelectorAll(`.reveal`);for(let t=0;t<e.length;t++){let n=window.innerHeight;e[t].getBoundingClientRect().top<n-100&&e[t].classList.add(`active`)}}window.addEventListener(`scroll`,e),window.addEventListener(`load`,e),document.addEventListener(`DOMContentLoaded`,e);"],["D:/TRABAJO/FixByte/src/pages/index.astro?astro&type=script&index=0&lang.ts","function e(){let e=document.getElementById(`particleCanvas`);if(!e)return;let t=e.getContext(`2d`);if(!t)return;let n=[],r=[`#00c6ff`,`#8E2DE2`,`#0072ff`,`#f5af19`];function i(){let t=e.parentElement;t&&(e.width=t.offsetWidth,e.height=t.offsetHeight)}function a(){return{x:Math.random()*e.width,y:Math.random()*e.height,size:Math.random()*3+1,speedX:(Math.random()-.5)*.8,speedY:(Math.random()-.5)*.8,color:r[Math.floor(Math.random()*r.length)],opacity:Math.random()*.5+.2}}function o(){i(),n=[];for(let e=0;e<30;e++)n.push(a())}function s(){for(let e=0;e<n.length;e++)for(let r=e+1;r<n.length;r++){let i=n[e].x-n[r].x,a=n[e].y-n[r].y,o=Math.sqrt(i*i+a*a);o<120&&(t.beginPath(),t.strokeStyle=`rgba(0, 198, 255, ${.1*(1-o/120)})`,t.lineWidth=.5,t.moveTo(n[e].x,n[e].y),t.lineTo(n[r].x,n[r].y),t.stroke())}}function c(){t.clearRect(0,0,e.width,e.height),n.forEach(n=>{n.x+=n.speedX,n.y+=n.speedY,(n.x<0||n.x>e.width)&&(n.speedX*=-1),(n.y<0||n.y>e.height)&&(n.speedY*=-1),t.beginPath(),t.arc(n.x,n.y,n.size,0,Math.PI*2),t.fillStyle=n.color,t.globalAlpha=n.opacity,t.fill(),t.globalAlpha=1}),s(),requestAnimationFrame(c)}o(),c(),window.addEventListener(`resize`,()=>{i()})}e();var t=document.getElementById(`mobileMenuBtn`),n=document.getElementById(`navLinks`);t&&n&&(t.addEventListener(`click`,()=>{n.classList.toggle(`active`)}),n.querySelectorAll(`a`).forEach(e=>{e.addEventListener(`click`,()=>{n.classList.remove(`active`)})}));"]],"assets":["/app.png","/dashboard.png","/ecommerce.png","/favicon.ico","/favicon.svg","/hero-code.png","/hero-laptop.png","/landing.png","/_astro/Layout.H25qYCl_.css","/_astro/dashboard.C5pBwuHU.css","/_astro/dashboard.BSQQ58xU.css","/_astro/pendiente.DaN80UbG.css","/_astro/index.Fk6fiORk.css","/_astro/login.BGoWvjGr.css","/_astro/register.CCQpRiPk.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"aSCFwQ5m9WZ7McCZa4qiPxZRpcPupIYhHMiH7rNjwTQ=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "c06bc22f-48a0-461a-ace0-8699c84f8a38") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
